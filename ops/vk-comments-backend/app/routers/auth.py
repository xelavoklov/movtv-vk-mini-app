...
async def auth_vk(body: VKAuthRequest, db: AsyncSession = Depends(get_db)):
    ...
    first_name = body.first_name or params.get("vk_user_first_name") or ""
    last_name = body.last_name or params.get("vk_user_last_name")
    screen_name = body.screen_name or params.get("vk_user_screen_name")
    photo_100 = body.photo_100 or params.get("vk_user_photo_100")
